<?php 
    ...
    $meta_authors = "Team 11 aka The Forum";
    $css = "";
    include "header.php";
?>    
...
<div class="container bod">
    ...
    <p>
        ...
        Doors open at 10:30pm and performance times may vary. Performers may not take the stage until much later. 
        No refunds will be issued if tickets are scanned. <br>
        Upscale nightclub attire is required. No athletic apparel. Standing room only. <br>
        The venue reserves the right to implement security procedures designed to protect the 
        experience for all of our customers. <br>
    </p>
</div>
